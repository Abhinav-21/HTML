...
let colour = ["btn-primary","btn-secondary","btn-success","btn-danger","btn-warning","btn-info","btn-light","btn-dark","btn-link"]
...
for (let i = 0; i < document.querySelectorAll("button.btn.btn-secondary").length; i++) {
    document.querySelectorAll("button.btn.btn-secondary")[i].addEventListener("mouseover", function(){
